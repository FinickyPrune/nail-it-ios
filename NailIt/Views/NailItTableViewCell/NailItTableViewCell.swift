...
class NailItTableViewCell: UITableViewCell {
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        if cellType == .service {
            contentView.layer.borderColor = selected ? Appearance.Color.nailItOrangeColor.cgColor : UIColor.clear.cgColor
        }
    }
    ...
    func configure(with service: Service) {
        ...
        subtitleLabel.text = "\(service.price)\("NailIt.currency".localized)"
